                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="card-title">Les chambres Libres</h5>
                                        <h6 class="card-subtitle">Les chambres Libres dans l'hotel </h6>
                                    </div>
                                    <!--div class="ml-auto">
                         ...
                         require('config/database.php');
                            $QueryAffichageReservations = $db->prepare("SELECT *FROM chambre  WHERE etatChbre='Libre' order by idchamb desc");
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><span class="text-danger"><?php echo $_reponses->etatChbre ?></span></td-->
                                        </tr>
                                        <?php
