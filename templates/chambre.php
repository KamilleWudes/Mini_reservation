...
<div class="hero-wrap" style="background-image: url('images/mini_image/12_z.webp');">
      ...
      <div class="container-fluid px-8">
        <div class="room-wrap d-md-flex">
          ...
          <div class="half left-arrow d-flex align-items-center">
           ...
           <br>   <p class="pt-1"><a href="?page=singleRoms&action=<?=$reponse->idchamb?>" class="btn-custom px-3 py-2">EN SAVOIR PLUS <span class="icon-long-arrow-right"></span></a></p>
            ...
            <h3 class="mb-2">Chambre <?= $reponse->etatChbre ?> </h3> </div>
          </div>
        </div>
      </div>
