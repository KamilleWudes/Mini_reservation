<div class="hero-wrap" style="background-image: url('images/mini_image/chambureau.webp');">
  ...
  <div class="container-fluid px-0">
        ...
        <div class="room-wrap d-md-flex">
          ...
          <div class="half left-arrow d-flex align-items-center">
            <div class="text p-4 p-xl-5 text-center">
              ...
              <p class="mb-0"><span class="price mr-1"><?= $reponse->prixChambre; ?> FCFA</span> <span class="per">par nuits</span></p>
              <h3 class="mb-3"><?= $reponse->libelchamb ?></h3>
              <h3 class="mb-2">Occupation max <?= $reponse->nbrPlaceChambre ?> personnes</h3>
              <p class="pt-1"><a href="?page=singleRoms" class="btn-custom px-3 py-2">EN SAVOIR PLUS <span class="icon-long-arrow-right"></span></a></p>
    ...
    <div class="row mt-5">
      <div class="col text-center">
        <div class="block-27">
          <ul>
            <li><a href="?page=disponible2">&lt;</a></li>
            <li class="?page=disponible1"><span>1</span></li>
            <li><a href="?page=disponible2">2</a></li>
            <li><a href="?page=disponible1">&gt;</a></li>
          </ul>
        </div>
      </div>
    </div>
